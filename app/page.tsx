...
const offersCardsRef = useRef<HTMLDivElement>(null)
offersCardsRef.current?.querySelectorAll()
  ...
  return (
    <>
      ...
      <div ref={offersCardsRef} /*style={{marginLeft:`${scrollPosition}px`}}*/  className="offer-cards-wrapper p-6 gap-6">
